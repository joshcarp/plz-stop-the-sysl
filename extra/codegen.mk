# Master: github.com/anz-bank/sysl-go/codegen/arrai/codegen.mk
#
...
DOCKER = docker
AUTO = arrai --out=dir:$(1) $(SYSL_GO_ROOT)/codegen/arrai/auto.arrai
...
$(codegen): $(SYSL_GO_ROOT)/codegen/arrai/codegen.mk
